...
> Hello Rails - API Only is an exercise to setup React + RoR as two different apps, by creating a React front-end with a Rails back-end and connecting them to display a random message. The React front-end can be found [here](https://github.com/Iqbal-Elham/hello-react-front-end).
...
```sh
  cd my-folder
  git clone https://github.com/iqbal-elham/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/iqbal-elham/hello-rails-back-end/issues).
